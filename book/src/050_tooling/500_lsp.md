...
version. Hover, definition, references, rename, document symbols, and
completion reuse that snapshot until `didChange` or `didClose` invalidates it.
A fresh `didOpen` starts a new snapshot for the new in-memory version.
