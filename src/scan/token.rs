...
impl fmt::Display for KEYWORD {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        match self {
            ...
            operator(OPERATOR::assign_) => write!(f, "{: <10} {: <10}", "OPERATOR", "assign"),
            operator(OPERATOR::assign2_) => write!(f, "{: <10} {: <10}", "OPERATOR", "assign2"),
            operator(OPERATOR::flow_) => write!(f, "{: <10} {: <10}", "OPERATOR", "flow"),
            operator(OPERATOR::flow2_) => write!(f, "{: <10} {: <10}", "OPERATOR", "flow2"),
            operator(OPERATOR::add_) => write!(f, "{: <10} {: <10}", "OPERATOR", "add"),
            operator(OPERATOR::subtract_) => write!(f, "{: <10} {: <10}", "OPERATOR", "subtract"),
            operator(OPERATOR::multiply_) => write!(f, "{: <10} {: <10}", "OPERATOR", "multiply"),
            operator(OPERATOR::divide_) => write!(f, "{: <10} {: <10}", "OPERATOR", "divide"),
            operator(OPERATOR::greater_) => write!(f, "{: <10} {: <10}", "OPERATOR", "greater"),
            operator(OPERATOR::less_) => write!(f, "{: <10} {: <10}", "OPERATOR", "less"),
            operator(OPERATOR::equal_) => write!(f, "{: <10} {: <10}", "OPERATOR", "equal"),
            operator(OPERATOR::greatereq_) => write!(f, "{: <10} {: <10}", "OPERATOR", "greatereq"),
            operator(OPERATOR::lesseq_) => write!(f, "{: <10} {: <10}", "OPERATOR", "lesseq"),
            operator(OPERATOR::addeq_) => write!(f, "{: <10} {: <10}", "OPERATOR", "addeq"),
            operator(OPERATOR::subtracteq_) => write!(f, "{: <10} {: <10}", "OPERATOR", "subtracteq"),
            operator(OPERATOR::multiplyeq_) => write!(f, "{: <10} {: <10}", "OPERATOR", "multiplyeq"),
            operator(OPERATOR::divideeq_) => write!(f, "{: <10} {: <10}", "OPERATOR", "divideeq"),
            operator(OPERATOR::shiftleft_) => write!(f, "{: <10} {: <10}", "OPERATOR", "shiftleft"),
            operator(OPERATOR::shiftright_) => write!(f, "{: <10} {: <10}", "OPERATOR", "shiftright"),
