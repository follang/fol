...
pub use cli::{
    ...
    CompletionShellArg, EditorPathCommand, EditorReferenceCommand, EmitCommand,
...
pub use editor::{
    ...
    editor_references_command, editor_semantic_tokens_command, editor_symbols_command,
