...
(typed_binding type: (type_expr (identifier) @type.builtin) (#match? @type.builtin "^(int|bol|str|flt|chr|never)$"))
(param type: (type_expr (identifier) @type.builtin) (#match? @type.builtin "^(int|bol|str|flt|chr|never)$"))
(return_type (type_expr (identifier) @type.builtin) (#match? @type.builtin "^(int|bol|str|flt|chr|never)$"))
(error_type (type_expr (identifier) @type.builtin) (#match? @type.builtin "^(int|bol|str|flt|chr|never)$"))
(ali_decl target: (type_expr (identifier) @type.builtin) (#match? @type.builtin "^(int|bol|str|flt|chr|never)$"))
(typed_binding type: (type_expr (identifier) @type) (#not-match? @type "^(int|bol|str|flt|chr|never)$"))
(param type: (type_expr (identifier) @type) (#not-match? @type "^(int|bol|str|flt|chr|never)$"))
(return_type (type_expr (identifier) @type) (#not-match? @type "^(int|bol|str|flt|chr|never)$"))
(error_type (type_expr (identifier) @type) (#not-match? @type "^(int|bol|str|flt|chr|never)$"))
(ali_decl target: (type_expr (identifier) @type) (#not-match? @type "^(int|bol|str|flt|chr|never)$"))
