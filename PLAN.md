...
- [x] String, character, raw-string, and raw-character handling is not clean.
...
- [x] Phase 4: front-end contract freeze
...
- [x] Decide whether raw-vs-cooked form needs separate token kinds.
...
- [x] Keep type-path handling and value-path handling deliberate.
...
- [x] Stop adding semantic-like checks during this hardening cycle unless they are required to preserve AST correctness.
...
- [x] Add shape tests where ambiguity currently exists.
...
- [x] Normalize "expected X" wording.
...
- [x] root AST invariants
- [x] declaration invariants
