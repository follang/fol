use super::*;
    ...
    fn test_top_level_for_typed_binder_requires_matching_iteration_name() {
        let mut file_stream =
            FileStream::from_file("test/parser/simple_for_typed_binder_mismatch.fol")
        ...
        let first_message = parse_error.to_string();
        assert!(
            first_message.contains("Typed iteration binder 'item' must match the iteration variable before 'in'"),
