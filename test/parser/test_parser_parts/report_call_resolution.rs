...
fn test_function_custom_error_type_rejects_report_call_with_unknown_arity() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_fun_error_type_report_unknown_arity_call.fol")
...
fn test_procedure_custom_error_type_rejects_report_call_with_unknown_arity() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_pro_error_type_report_unknown_arity_call.fol")
...
fn test_function_custom_error_type_rejects_report_unknown_called_method() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_fun_error_type_report_unknown_method_call.fol")
...
fn test_procedure_custom_error_type_rejects_report_unknown_called_method() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_pro_error_type_report_unknown_method_call.fol")
...
fn test_function_custom_error_type_rejects_report_method_call_with_unknown_arity() {
    ...
    let first_message = parse_error.to_string();
    assert!(
        first_message.contains("Unknown reported callable 'parser.make_err' with 2 argument(s)")
            && first_message.contains("available arity(s): 1"),
...
fn test_function_custom_error_type_accepts_report_method_call_result_from_receiver_decl() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_fun_error_type_report_method_call_result_ok.fol")
...
fn test_procedure_custom_error_type_accepts_report_method_call_result_from_receiver_decl() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_pro_error_type_report_method_call_result_ok.fol")
...
fn test_procedure_custom_error_type_rejects_report_forward_overloaded_method_call_result_by_arity_mismatch(
    ...
    .expect("Should read forward overloaded procedure report method-call result mismatch fixture");
...
fn test_receiver_method_rejects_conflicting_duplicate_return_type_signature() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_fun_receiver_conflicting_return_signature.fol")
    ...
    let errors = parser
        .parse(&mut lexer)
        .expect_err("Parser should reject conflicting duplicate receiver method return signatures");
...
fn test_receiver_procedure_method_rejects_conflicting_duplicate_return_type_signature() {
    let mut file_stream =
        FileStream::from_file("test/parser/simple_pro_receiver_conflicting_return_signature.fol")
            .expect(
...
fn test_function_accepts_duplicate_signature_with_same_return_type() {
    ...
    parser
        .parse(&mut lexer)
        .expect("Parser should accept duplicate function signature when return type is the same");
}
...
fn test_procedure_accepts_duplicate_signature_with_same_return_type() {
    ...
    parser
        .parse(&mut lexer)
        .expect("Parser should accept duplicate procedure signature when return type is the same");
}
...
fn test_function_accepts_same_name_different_arity_with_different_return_types() {
    ...
    parser
        .parse(&mut lexer)
        .expect("Parser should accept same function name with different arity and return types");
}
