...
mod parser_tests {
    ...
    fn test_routine_generic_headers_reject_default_values() {
        let mut file_stream = FileStream::from_file(
            "test/parser/simple_routine_generics_default_forbidden.fol",
        )
    ...
    fn test_when_on_case_missing_close_paren_reports_parse_error() {
        let mut file_stream =
            FileStream::from_file("test/parser/simple_fun_when_on_missing_close.fol")
    ...
    fn test_procedure_method_receiver_syntax_rejects_builtin_receiver_type() {
        ...
        let mut parser = AstParser::new();
        let errors = parser.parse(&mut lexer).expect_err(
            "Parser should reject procedure receiver syntax with builtin receiver type",
        );
    ...
    fn test_top_level_each_typed_binder_requires_matching_iteration_name() {
        ...
        let first_message = parse_error.to_string();
        assert!(
            first_message.contains("Typed iteration binder 'line' must match the iteration variable before 'in'"),
    ...
    fn test_var_parsing_supports_qualified_and_bracketed_type_hints() {
        let mut file_stream =
            FileStream::from_file("test/parser/simple_var_qualified_type.fol")
    ...
    fn test_let_parsing_supports_bracketed_type_hints() {
        let mut file_stream =
            FileStream::from_file("test/parser/simple_fun_let_bracket_type.fol")
    ...
    fn test_var_type_hint_missing_bracket_close_reports_parse_error() {
        let mut file_stream =
            FileStream::from_file("test/parser/simple_var_type_missing_close.fol")
    ...
    fn test_range_expressions_parse_in_assignment_and_return() {
        ...
        match ast {
            AstNode::Program { declarations } => {
                ...
                assert!(has_range_assignment, "Assignment should parse closed range expression");
                assert!(has_range_return, "Return should parse range expression with arithmetic bounds");
            }
            _ => panic!("Expected program node"),
        }
    }
