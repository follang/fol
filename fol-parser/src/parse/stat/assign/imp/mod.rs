...
use crate::nodes::{Node, Nodes, NodeStatDecL};
use crate::token::*;
use fol_lexer;
use super::Parse;
use crate::parse::{check, Body};

use crate::parse::stat::ParserStat;
use crate::parse::stat::assign::opts::*;
use crate::parse::stat::ident::*;
use crate::parse::stat::parameters::*;
use crate::parse::stat::generics::*;
...
impl Parse for ParserStatAssImp {
    ...
    fn parse(&mut self, lex: &mut lexer::Elements) -> Vod {
        ...
        let mut body = ParserStat::init(Body::Imp, self.level() + 1);
